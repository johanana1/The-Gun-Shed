...
/* ── Constants ─────────────────────────────────────── */
const MANUFACTURERS = ["Aero Precision","American Tactical","Anderson Manufacturing","Anschutz","Armalite","Arsenal Inc.","Astra","ATI","Auto Ordnance","Baer","Ballard","Barrett","Beeman","Benelli","Beretta","Bergara","Bersa","Blaser","Bond Arms","Browning","BSA","Bushmaster","Cabela's","Caesar Guerini","Calico","Canadian Arms","Canik","Caracal","Carter Gun Works","Caspian","Century Arms","Charter Arms","Chiappa","Churchill","Cimarron","Citadel","Cobra","Cobra Enterprises","Colt","CZ","CZ-USA","Dakota Arms","Daniel Defense","Davide Pedersoli","DCI","Detonics","DNA","EDM Arms","Enterprise Arms","Essex","European American Armory","Fabrique Nationale","Falcon","FN Herstal","Forehand & Wadsworth","Forjas Taurus","Fox","Fusion Firearms","GA Precision","Galena Industries","Garcia","GECO","Gevarm","Glock","Greener","Greifelt","Grendel","Griffon","Grulla","Guerini","H&K","Haenel","Hambrusch","Hammerli","Harrington & Richardson","Harris","Hart","Hatfield","Hawes","Hawken","Heckler & Koch","Henry","Heym","High Standard","HK","Hopkins & Allen","Horton","Howa","Hudson","Huglu","Huntington","IGA","Iver Johnson","Izhevsk","James Purdey","Janssen","Jäger","Jeffery","Jenkins","Jenkinson","Jimenez","Johnson","Johnson Automatics","Jones","Joslyn","Kahr","Kaiser","Kalashnikov","Kimber","King","Korth","Krieghoff","Lahti","Lander","Langenhan","Lathrop","Laurel","Lauterbach","Lee","Lee Enfield","Les Baer"," Lever Arms","London Armory","Luger","M1 Garand","Magnum Research","Makarov","Mannlicher","Marlin","Mars","Mauser","McMillan","Merkel","Merikanti","Metropolitan Arms","MG Arms","Midland","Military Armaments","Miller","Miroku","Mitchell","Mossberg","Mondragon","Mosin-Nagant","Mossberg","Mountain Rifle","Murata","Murphy","NAG","NAM","Nambu","National Armory","National Ordnance","Navy Arms","Neumann","Neustadt","Nevada","New Haven","Newburyport","Newcomb","Newfoundland","Newport","Newton","Newton Arms","Nexus","Niederlänische","Nightingale","Nikko","Nikko Stirling","Nitrochemie","Nitro","Noranco","Norinco","Normark","North","North American","Northampton","Northampton Arms","Northeast Arms","Northeast Pennsylvania","Northern","Northern Arms","Northeastern","Northerner","Northgate","Northlake","Northwest","Northwest Arms","Northwestern","Northwesterner","Norton","Nott","Nottingham","Nourmahall","Nova","Novaguanex","Novelty","Novelli","Novello","Novo","Novocher","Novodar","Novograd","Novograds","Novojedyn","Novojel","Novolage","Novomesser","Novomoskovsk","Novopass","Novopodolsk","Novorobert","Novorostov","Novoskolnik","Novospeed","Novotage","Novotaj","Novotang","Novotar","Novotasse","Novotch","Novotenor","Novotex","Novothe","Novotheus","Novotil","Novotiller","Novotine","Novotle","Novotma","Novotoge","Novotom","Novoton","Novotone","Novotonus","Novotop","Novotope","Novotora","Novotorem","Novotor","Novotorial","Novotoric","Novotorie","Novotorn","Novotoro","Novotors","Novotory","Novotose","Novotos","Novototage","Novototam","Novototane","Novototap","Novototary","Novototas","Novototat","Novototaurus","Novototean","Novototeca","Novototecis","Novototects","Novototele","Novototelic","Novototella","Novototelle","Novototeles","Novototema","Novototeme","Novototemes","Novototemic","Novototena","Novototence","Novototendor","Novototene","Novototenes","Novototeng","Novototenis","Novototenna","Novototens","Novototent","Novototenue","Novototeon","Novoteonas","Novotepara","Novotepia","Novotepian","Novotepichos","Novotepid","Novotepidia","Novotepidius","Novotepie","Novotepies","Novotepik","Novotepil","Novotepils","Novotepim","Novotepin","Novotepina","Novotepine","Novotepines","Novotepins","Novotepion","Novotepione","Novotepiones","Novotepior","Novotepios","Novotepir","Novotepira","Novotepire","Novotepis","Novotepisa","Novotepite","Novotepite","Novotepitia","Novotepitid","Novotepitidae","Novotepitidae","Novotepitida","Novotepitidas","Novotepitideo","Novotepitides","Novotepitian","Novotepitic","Novotepiticum","Novotepitida","Novotepitidae","Novotepitious","Novotepitium","Novotepitius","Novotepito","Novotepitous","Novotepitus","Novotepity","Novotepiz","Novotepizo","Novotepizos","Novotepizuc","Novotepizues","Novotepizuni","Novotepizuns","Novotepizus","Novotepizu","Novotepizut","Novotepizute","Novotepizutum","Novotepizutu","Other"];
